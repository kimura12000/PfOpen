      ...
      <div className={styles.container}>
        ...
        <main ref={ThreeDref}>
          ...
          <div className="wrapper5" style={{ height: '1220px',position:'relative', zIndex:'10' }}>
            <p style={{height: '400px', display:'flex', justifyContent:'center', alignItems:'flex-end',lineHeight:'36px', letterSpacing:'0.1em', fontSize:'24px', fontWeight:'bold', marginBottom:'72px' }}>バウンダリ（境界）を超えてデザインする</p>
